...
# # Take a look at the Tg variable's nc attributes (units etc)
# ncatt_get(nc_data, attributes(nc_data$var)$names[1])
# 
# # Retrieve a matrix of the Tg data using the ncvar_get function:
# tg_mean <- ncvar_get(nc_data, attributes(nc_data$var)$names[1]) # error Error: cannot allocate vector of size 32.6 Gb
# # Print the data's dimensions
# dim(tg_mean)

########################################################
# 
# # Odpiranje in risanje za en ?asovni korak, primer za 1. 1. 1950
# library(raster)
# source("dmrgrid.r")
# pretvorba_sek_v_dan = 60*60*24
# 
# # for(i in 1:length(nc_data$dim$time$vals)){
# i=151
# # rasterize data for every time step (for variable "temperature")
# r <- raster(paste0(path,"evspsblpot_12km_ARSO_v5_day_19810101_20101231.nc"),
#             varname="evspsblpot",band=i)
# rxy <- as.data.frame(r,xy=T)
# # plot in ggplot2
# ggplot()+
#   geom_tile(data=rxy,aes(x=x,y=y,fill=rxy[,3]))+
#   scale_fill_distiller(palette = "Spectral") +
#   labs(x="Lon",y="Lat",title=as.POSIXct(i*pretvorba_sek_v_dan,origin="1981-05-31 00:00:00"))+
#   xlim(13, 17) + ylim(45,47) +
#   scale_colour_manual(breaks = c("10","15","20","25","30")) 
# 
# 
# # i=151
# # path1 <- "C:/Users/ZalaZn/Documents/ZALA BF delo/MR/dataset-insitu-gridded-observations-europe/CDS_E-OBS/"                                 # slu?ba
# # r <- raster(paste0(path1,"tg","_ens_mean_0.1deg_reg_v27.0e.nc"),
# #             varname="tg",band=i)
# # rxy <- as.data.frame(r,xy=T)
# # ggplot()+
# #   geom_tile(data=rxy,aes(x=x,y=y,fill=rxy[,3]))+
# #   scale_fill_distiller(palette = "Spectral") +
# #   labs(x="Lon",y="Lat",title=as.POSIXct(i*pretvorba_sek_v_dan,origin="1950-01-01 00:00:00"))+
# #   scale_colour_manual(breaks = c("10","15","20","25","30")) 
# 
# 
# # Load shapefile
# shapename <- read_sf("./Slovenia_shapefile/si_10km.shp")
...
vsi_podatki <- readRDS(file = "C:/Users/ZalaZn/OneDrive - Univerza v Ljubljani/CRP kazalniki 2024/kazalniki_OPSI_historical_GS.rds")
                       #delo/faktorji_hist_1981-2010.rds")
...
#     ggsave(paste0("rezultati/karte/hist/yearly_",kaz[k],"_",i,".png"),width = 10, height = 7)
#   }
# }
...
#     #   theme_light(base_size = 17)
#     # print(plot_1)
#     # ggsave(paste0("karte/",rcp,"/period_mean_",kaz[k],"_",model[z],"_",zac,"-",kon,".png"),width = 10, height = 7)
...
#       theme_light(base_size = 17)
#     print(plot_1)
#     ggsave(paste0("karte/",rcp,"/period_mean_",kaz[k],"_",zac,"-",kon,".png"),width = 10, height = 7)
#   
...
grafi_SLO <- function(rattler.vsi, rcp, obd, kaz1){
  ...
  #   ggsave(paste0("karte/",rcp,"_mediana/",kaz1,"_",obd,"_median.png"),width = 10, height = 7)
  # 
  ...
  #                         axis.title.x=element_blank(),
  #                         axis.title.y=element_blank())
  # ggsave(paste0("karte/",rcp,"_mediana/",kaz1,"_",obd,"_min.png"),width = 10, height = 7)
  # 
  ...
  #                         axis.title.x=element_blank(),
  #                         axis.title.y=element_blank())
  # ggsave(paste0("karte/",rcp,"_mediana/",kaz1,"_",obd,"_max.png"),width = 10, height = 7)
...
# k=1
# med1 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = kaz[1])[1:4]
# med2 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = kaz[1])[1:4]
# 
# med3 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = kaz[1])[1:4]
# med4 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = kaz[1])[1:4]
# 
# min1 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = kaz[1])[c(1:3,5)]
# min2 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = kaz[1])[c(1:3,5)]
# 
# min3 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = kaz[1])[c(1:3,5)]
# min4 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = kaz[1])[c(1:3,5)]
# 
# max1 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = kaz[1])[c(1:3,6)]
# max2 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = kaz[1])[c(1:3,6)]
# 
# max3 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = kaz[1])[c(1:3,6)]
# max4 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = kaz[1])[c(1:3,6)]
# 
# for(k in (2:31)){
# 
#   med01 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = kaz[k])
#   med02 <- grafi_SLO(rattler.vsi = vsi_podatki_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = kaz[k])
# 
#   med03 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = kaz[k])
#   med04 <- grafi_SLO(rattler.vsi = vsi_podatki_70_10_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = kaz[k])
# 
...
# 
# saveRDS(med1, file = "mediana_41-70_rcp45.rds")
# saveRDS(med2, file = "mediana_41-70_rcp85.rds")
# saveRDS(med3, file = "mediana_71-00_rcp45.rds")
# saveRDS(med4, file = "mediana_71-00_rcp85.rds")
# 
# saveRDS(min1, file = "min_41-70_rcp45.rds")
# saveRDS(min2, file = "min_41-70_rcp85.rds")
# saveRDS(min3, file = "min_71-00_rcp45.rds")
# saveRDS(min4, file = "min_71-00_rcp85.rds")
# 
# saveRDS(max1, file = "max_41-70_rcp45.rds")
# saveRDS(max2, file = "max_41-70_rcp85.rds")
# saveRDS(max3, file = "max_71-00_rcp45.rds")
# saveRDS(max4, file = "max_71-00_rcp85.rds")
#
...
###############################################################################################################################################
# 
# # DODAJANJE kazalnikov za obdobja projekcij in rcp4.5 ter 8.5
# 
# me_podatki_71_00_rcp45 = readRDS(file = "mediana_71-00_rcp45.rds")
# me_podatki_71_00_rcp85 = readRDS(file = "mediana_71-00_rcp85.rds")
# me_podatki_41_70_rcp45 = readRDS(file = "mediana_41-70_rcp45.rds")
# me_podatki_41_70_rcp85 = readRDS(file = "mediana_41-70_rcp85.rds")

vsi_podatki_71_00_rcp45 = readRDS(file = "kazalniki_71-00_rcp45.rds")
vsi_podatki_71_00_rcp85 = readRDS(file = "kazalniki_71-00_rcp85.rds")
vsi_podatki_41_70_rcp45 = readRDS(file = "kazalniki_41-70_rcp45.rds")
vsi_podatki_41_70_rcp85 = readRDS(file = "kazalniki_41-70_rcp85.rds")

dodaj_z_in_faktorje <- function(vsi_podatki,vsi_podatki_1){
  # vsi_podatki_M_SD = vsi_podatki[1,66:127] # kopiram M-je in SD-je za 1981-2010, 
  # # da lahko izra?unam z vrednosti obdobja 2041-2100
  # # vsi_podatki_2 <- cbind(vsi_podatki_1, vsi_podatki_M_SD)
  # vsi_podatki_2 <- vsi_podatki_1
  # 
  # for(i in seq(1,31,by=1)){
  #   z <- (vsi_podatki_2[,3+i] - vsi_podatki_M_SD[1,i])/vsi_podatki_M_SD[1,31+i]
  #   vsi_podatki_2 <- cbind(vsi_podatki_2,z)
  #   print(i)
  # }
  
  
  M_vrednosti <- as.numeric(vsi_podatki[1, 66:96])
  SD_vrednosti <- as.numeric(vsi_podatki[1, 97:127])
  
  z_vrednosti <- sweep(vsi_podatki_1[, 5:35], 2, M_vrednosti, FUN = "-")
  z_vrednosti <- sweep(z_vrednosti, 2, SD_vrednosti, FUN = "/")
  vsi_podatki_2 <- cbind(vsi_podatki_1, z_vrednosti)
  imena_z <- paste0("z", colnames(vsi_podatki_1)[5:35])
  colnames(vsi_podatki_2)[(ncol(vsi_podatki_1) + 1):ncol(vsi_podatki_2)] <- imena_z
  
  # colnames(vsi_podatki_2) <- c(colnames(vsi_podatki_2)[1:34], colnames(vsi_podatki[35:65]))
  ...
  # vsi_podatki <- rbind(vsi_podatki,vsi_podatki_3) #### POMEMBNO, KONCNA SPREMEMBA ORIGINALNEGA NIZA 1981-2010, DODAMO 2011-2022 ZA JABLJE IN RAKICAN
}
vsi_podatki <- readRDS(file = "../kazalniki_1981-2020.rds")
...
grafi_lepi <- function(rattler.vsi, rcp, obd, kaz1, n){
  ...
  min_n <- c(-5,-10, -4,-4,-4,-2)
  max_n <- c( 5,10,  4, 4, 4, 2)
  ...
  a1 <- ggplot(data=rattler.mediana) +
    ...
    theme_map() + theme(legend.position = c(.9, .3), legend.title = element_text(face = "bold", size=16),
                          ...
                          axis.title.y=element_blank())
  a1
    ggsave(paste0("karte/",rcp,"_mediana/faktor",kaz1,"_",obd,".png"),a1,width = 10, height = 7)
  ...
  min_ano <- c(-3,-8, -1.5, -4,-1, -1, -2)
  max_ano <- c( 3, 8,  1.5,  4, 1,  1,  2)
  ...
  ggsave(paste0("karte/",rcp,"_mediana/ano_mediana_",kaz1,"_",obd,".png"),ano_plot,width = 10, height = 7)
  ...
  ggplot() +
    ...
    theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=16),
          ...
          axis.title.x=element_blank(),
          axis.title.y=element_blank())
  ggsave(paste0("karte/",rcp,"_mediana/ano_min_",kaz1,"_",obd,".png"),width = 10, height = 7)
  ...
  ggplot() +
    ...
    theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=16),
          ...
          axis.title.x=element_blank(),
          axis.title.y=element_blank())
  ggsave(paste0("karte/",rcp,"_mediana/ano_max_",kaz1,"_",obd,".png"),width = 10, height = 7)
...
# grafi_lepi(faktorji_71_00_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = "zkonec_rastne")
me_71_00_rcp45 <- grafi_lepi(faktorji_71_00_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = "zekstremne_T", n=4)
...
# grafi_lepi(faktorji_71_00_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = "zkonec_rastne")
me_71_00_rcp85 <- grafi_lepi(faktorji_71_00_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = "zekstremne_T", n=4)
me_71_00_rcp85 <- grafi_lepi(faktorji_71_00_rcp85, rcp = "rcp45", obd = "2071-2100", kaz1 = "zvisoke_padavine", n=5)
me_71_00_rcp85 <- grafi_lepi(faktorji_71_00_rcp85, rcp = "rcp45", obd = "2071-2100", kaz1 = "zmin_padavine", n=6)

me_41_70_rcp45 <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zpozeba", n=1)
me_41_70_rcp45HS <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zvrocinski_stres", n=2)
me_41_70_rcp45GS <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zrastna", n=3)
# grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zkonec_rastne")
me_41_70_rcp45 <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zekstremne_T", n=4)
me_41_70_rcp45HP <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zvisoke_padavine", n=5)
me_41_70_rcp45 <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zmin_padavine", n=6)
library(patchwork)

top <- (me_41_70_rcp45HP | me_41_70_rcp45GS) + plot_layout(widths = c(1, 1))
# Spodaj: prazen | a6 | prazen, a6 širši kot prazna
bottom <- (plot_spacer() | me_41_70_rcp45HS | plot_spacer()) + 
...
g
ggsave("delo/karte/Fig7.png", g, width = 24, height = 18, dpi = 300)
...
# grafi_lepi(faktorji_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = "zkonec_rastne")
me_41_70_rcp85 <- grafi_lepi(faktorji_41_70_rcp85, rcp = "rcp85", obd = "2041-2070", kaz1 = "zekstremne_T", n=4)
...
# ggplot() +
#   geom_tile(data=me_41_70_rcp45-povp_hist,aes(x=lons,y=lats,fill=zpozeba)) +
...
povp_hist <- readRDS(file = "faktorji_hist_1981-2010.rds")
...
povp_hist_zrastna<-data.frame(lats=povp_hist$lats, lons = povp_hist$lons, hist=povp_hist$zrastna,
                              BED_hist=povp_hist$BEDD, su_hist=povp_hist$su,
...
anomalija_rastna_proj<-data.frame(lats=anomalija_rastna$lats, lons = anomalija_rastna$lons, 
                                  ...
                                  BED_proj=anomalija_rastna$BEDD, 
                                  su_proj=anomalija_rastna$su,
                                  growing_degree_day_proj=anomalija_rastna$growing_degree_days,
                                  TG_of_warmest_quarte_proj= povp_hist$TG_of_warmest_quarter,
                                  T_warmest_m_proj=povp_hist$T_warmest_m)
...
ano1<-ggplot() +
  ...
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu",limits=c(-1,1)) + # 
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") +
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
                     values = c("Jablje" = 17, "Rakican" = 16)) + # Specify shapes (24=triangle, 22=square)
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=16),
        ...
        axis.title.y=element_blank())
ano1
ggsave(paste0("karte/rcp45_mediana/anomalije_rastna_2041-2070.png"),ano1,width = 10, height = 7)
...
hist1
ggsave(paste0("karte/faktorrastna_1981-2010.png"),hist1,width = 10, height = 7)
...
proj1<-ggplot() +
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
proj1
# ggsave(paste0("karte/rcp45_mediana/faktorzrastna_2041-2070.png"),proj1,width = 10, height = 7)
...
colnames(anomalija_rastna)[3] <- "proj"
povp_hist_zrastna<-data.frame(lats=povp_hist$lats, lons = povp_hist$lons, hist=povp_hist$zrastna,
                              BED_hist=povp_hist$BEDD, su_hist=povp_hist$su,growing_degree_day_hist=povp_hist$growing_degree_days,
                              TG_of_warmest_quarte_hist= povp_hist$TG_of_warmest_quarter,T_warmest_m_hist=povp_hist$T_warmest_m)
anomalija_rastna_proj<-data.frame(lats=anomalija_rastna$lats, lons = anomalija_rastna$lons,proj=anomalija_rastna$zrastna,
                                  BED_proj=anomalija_rastna$BEDD, su_proj=anomalija_rastna$su,growing_degree_day_proj=anomalija_rastna$growing_degree_days,
                                  TG_of_warmest_quarte_proj= povp_hist$TG_of_warmest_quarter,T_warmest_m_proj=povp_hist$T_warmest_m)
anomalija_rastna_proj<- merge(povp_hist_zrastna,anomalija_rastna_proj,by=c("lats","lons"))
anomalija_rastna_proj$zrastna <- anomalija_rastna_proj$proj - anomalija_rastna_proj$hist
lok1 <- subset(anomalija_rastna_proj, lats == lat_Jablje & lons == lon_Jablje)
lok2 <- subset(anomalija_rastna_proj, lats == lat_Rakican & lons == lon_Rakican)
...
ano1<-ggplot() +
  geom_tile(data=anomalija_rastna_proj,aes(x=lons,y=lats,fill=zrastna)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu",limits=c(-2.5,2.5)) + # 
  coord_sf(crs = st_crs(4326)) +
  theme_map() + #labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=16),
        ...
        axis.title.y=element_blank())
ano1
ggsave(paste0("karte/rcp45_mediana/anomalije_rastna_2071-2100.png"),ano1,width = 10, height = 7)
...
ano1<-ggplot() +
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=16),
        ...
        axis.title.y=element_blank())
ano1
ggsave(paste0("karte/rcp85_mediana/anomalije_rastna_2071-2100.png"),ano1,width = 10, height = 7)
...
ggplot() +
  ...
  theme_map() + theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
                      ...
                      axis.title.x=element_blank(),
                      axis.title.y=element_blank())
ggsave(paste0("karte/faktorvisoke_padavine1981-2010.png"),width = 10, height = 7)
...
ano2<-ggplot() +
  ...
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-0.5, 0.5)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
                     values = c("Jablje" = 17, "Rakican" = 16)) + # Specify shapes (24=triangle, 22=square)  
  theme(legend.position = c(.9, .1),legend.title = element_text(face = "bold", size=18),
        text = element_text(size=18),
        plot.title = element_text(size=18),
        axis.title.x=element_blank(),
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_visoke_padavine_2041-2070.png"),ano2,width = 10, height = 7)
...
ano2<-ggplot() +
  geom_tile(data=anomalija_pad_proj,aes(x=lons,y=lats,fill=zvisoke_padavine)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-1, 1)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .1),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_visoke_padavine_2071-2100.png"),ano2,width = 10, height = 7)
...
ano2<-ggplot() +
  ...
  theme(legend.position = c(.9, .1),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp85_mediana/anomalije_visoke_padavine_2071-2100.png"),ano2,width = 10, height = 7)



# VROCINSKI STRES

me_41_70_rcp45 <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zvrocinski_stres", n=5)
...
b1 <- ggplot() +
  ...
  theme_map() + theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
                      ...
                      axis.title.y=element_blank())
b1
ggsave(paste0("karte/faktorvrocinski_stres1981-2010.png"),b1,width = 10, height = 7)
...
ano2<-ggplot() +
  ...
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-6.5,6.5)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_vrocinski_stres_2041-2070.png"),ano2,width = 10, height = 7)

# RCP4.5 2071-2100
me_71_00_rcp45 <- grafi_lepi(faktorji_71_00_rcp45, rcp = "rcp45", obd = "2071-2100", kaz1 = "zvrocinski_stres", n=5)
...
ano2<-ggplot() +
  geom_tile(data=anomalija_vroc_proj,aes(x=lons,y=lats,fill=zvrocinski_stres)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-21,21)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_vrocinski_stres_2071-2100.png"),ano2,width = 10, height = 7)


# RCP8.5
me_71_00_rcp85 <- grafi_lepi(faktorji_71_00_rcp85, rcp = "rcp85", obd = "2071-2100", kaz1 = "zvrocinski_stres", n=5)
...
ano2<-ggplot() +
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp85_mediana/anomalije_vrocinski_stres_2071-2100.png"),ano2,width = 10, height = 7)
...
povp_hist_zekstremne_T<-data.frame(lats=povp_hist$lats, lons = povp_hist$lons, hist=povp_hist$zekstremne_T,
...
anomalija_vroc1_proj<-data.frame(lats=anomalija_vroc1$lats, lons = anomalija_vroc1$lons, 
                                  proj=anomalija_vroc1$zekstremne_T,
                                  WSDI_proj=anomalija_vroc1$WSDI, 
                                  tn90p_proj=anomalija_vroc1$tn90p,
                                  vwd_proj=anomalija_vroc1$vwd)
anomalija_vroc1_proj<- merge(povp_hist_zekstremne_T,anomalija_vroc1_proj,by=c("lats","lons"))
anomalija_vroc1_proj$zekstremne_T <- anomalija_vroc1_proj$proj - anomalija_vroc1_proj$hist
povprecje_slovenije_hist_zekstremne_T<- mean(anomalija_vroc1_proj$hist)
povprecje_slovenije_proj_zekstremne_T<-mean(anomalija_vroc1_proj$proj)


me_41_70_rcp45 <- grafi_lepi(faktorji_41_70_rcp45, rcp = "rcp45", obd = "2041-2070", kaz1 = "zekstremne_T", n=4)
anomalija_vroc1 <- me_41_70_rcp45
colnames(anomalija_vroc1)[3] <- "proj"
povp_hist_zvroc1<-data.frame(lats=povp_hist$lats, lons = povp_hist$lons, hist=povp_hist$zekstremne_T)
anomalija_vroc1_proj<-data.frame(lats=anomalija_vroc1$lats, lons = anomalija_vroc1$lons, 
...
b1 <- ggplot() +
  geom_tile(data=povp_hist,aes(x=lons,y=lats,fill=zekstremne_T)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-4,4)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + #labs(x="G. dolzina",y="G. sirina",title="Hist 1981-2010") + 
  ...
  theme_map() + theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
                      ...
                      axis.title.y=element_blank())
b1
ggsave(paste0("karte/faktorekstremne_T1981-2010.png"),b1,width = 10, height = 7)
...
print(c(lok1$hist,lok1$zekstremne_T))
print(c(lok2$hist,lok2$zekstremne_T))
...
ano2<-ggplot() +
  geom_tile(data=anomalija_vroc1_proj,aes(x=lons,y=lats,fill=zekstremne_T)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-3,3)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_ekstremne_T_2041-2070.png"),ano2,width = 10, height = 7)
...
ano2<-ggplot() +
  geom_tile(data=anomalija_vroc1_proj,aes(x=lons,y=lats,fill=zekstremne_T)) +
  geom_sf(data=slovenia_nuts3_mapdata, fill = NA) +
  scale_fill_distiller("z", palette = "RdBu", limits = c(-7,7)) + # Use gradientn for custom palette
  coord_sf(crs = st_crs(4326)) +
  theme_map() + labs(x="G. dolzina",y="G. sirina",title="Anomalije") + 
  geom_point(data = pts, aes(x = lon, y = lat, shape = Location), size = 3) + # Map 'point_type' to shape
  scale_shape_manual(name = "Location", # Set the title for the shape legend
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp45_mediana/anomalije_ekstremne_T_2071-2100.png"),ano2,width = 10, height = 7)
...
ano2<-ggplot() +
  ...
  theme(legend.position = c(.9, .3),legend.title = element_text(face = "bold", size=18),
        ...
        axis.title.y=element_blank())
ano2
ggsave(paste0("karte/rcp85_mediana/anomalije_ekstremne_T_2071-2100.png"),ano2,width = 10, height = 7)
...
plot(test$leto, test$zekstremne_T)
